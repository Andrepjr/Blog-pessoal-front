...
import loginLogo from '../../assets/img/Foto-perfil.jpg'
import { toastAlerta } from '../../util/toastAlerta'
import  banner  from '../../assets/img/horizonte.jpg'
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      ...
      <div className="relative mt-[-6rem] h-72 flex flex-col bg-blue-500 text-white text-2xl items-center justify-center">
